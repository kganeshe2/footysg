...
{
  region.insert({_id:"R1",
                  region: "Central", 
                  country: "Singapore"});
  region.insert({_id:"R2",
                  region: "North", 
                  country: "Singapore"});
  region.insert({_id:"R3",
                  region: "East",   
                  country: "Singapore"});
  region.insert({_id:"R4",
                  region: "West", 
                  country: "Singapore"});
}

function createData_HourlyPriceByDay()
{
  hourlyPriceByDay.insert({_id:"H1",
                 fustalPitch : "P1",
                 day : "Monday",
                 startTime : "0800",
                 endTime : "0900",
                 price : "100"});
  hourlyPriceByDay.insert({_id:"H2",
                 fustalPitch : "P2",
                 day : "Friday",
                 startTime : "0800",
                 endTime : "0900",
                 price : "100"})
  hourlyPriceByDay.insert({_id:"H3",
                 fustalPitch : "P3",
                 day : "Tuesday",
                 startTime : "0800",
                 endTime : "0900",
                 price : "100"})
  hourlyPriceByDay.insert({_id:"H4",
                 fustalPitch : "P4",
                 day : "Wednesday",
                 startTime : "0800",
                 endTime : "0900",
                 price : "100"})
  hourlyPriceByDay.insert({_id:"H5",
                 fustalPitch : "P5",
                 day : "Wednesday",
                 startTime : "0800",
                 endTime : "0900",
                 price : "100"})
  hourlyPriceByDay.insert({_id:"H6",
                 fustalPitch : "P6",
                 day : "Thursday",
                 startTime : "0800",
                 endTime : "0900",
...
function createData_futsalParkDocument()
{
  futsalPark.insert({_id:"FP1",
                      name:"Bishan FP",
...
Meteor.startup(() => {
  ...
  if(region.find().count()<1)
  {
    createData_Region();
  }
  if(hourlyPriceByDay.find().count()<1)
  {
    createData_HourlyPriceByDay();
  }
  if(futsalPark.find().count()<1)
  {
    createData_futsalParkDocument();
  } 
  if(game.find().count()<1)
  {
    createData_game();
  }
 });
